...
Welcome to `kanban-python` contributor's guide.
...
If you experience bugs or general issues with `kanban-python`, please have a look
...
You can help improve `kanban-python` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`kanban-python` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `kanban-python`'s files. While this mechanism can
...
```
conda create -n kanban-python python=3 six virtualenv pytest pytest-cov
conda activate kanban-python
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/kanban-python.git
   cd kanban-python
   ```
...
5. Install [pre-commit]:
   ...
   `kanban-python` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/kanban-python
[issue tracker]: https://github.com/<USERNAME>/kanban-python/issues
